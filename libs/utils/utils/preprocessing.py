...
class MultiModalFreqSplitPreprocessor(torch.nn.Module):
    """
    Preprocess a batch of waveforms for multimodal training with 
    frequency splitting of the time domain.
    This includes whitening the time domain data and
    calculating the frequency domain data
    """
